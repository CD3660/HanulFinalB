...
=======
	<div class="col pb-4 mx-auto">
                                    <ul class="lgacc-tab">
    <li class="tab-item">
        <a class="tab-link" id="btn-search-id" href="javascript:void(0);">아이디 찾기</a>
    </li>
    <li class="tab-item">
        <a id="reset-password" class="tab-link" href="javascript:void(0)">비밀번호 재설정</a>
    </li>
</ul>
                                    <ul class="lgacc-tab justify-content-center">
                                            <li class="tab-item">
                                                <a id="btn-register" class="tab-link" href="javascript:void(0);" onclick="return false;">
                                                    <u>회원가입</u>
                                                </a>
                                            </li>
                                        </ul>
